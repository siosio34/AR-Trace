...
public class MixListView extends ListActivity {
	...
	//[Full request URI: http://map.naver.com/search2/interestSpot.nhn?type=ACCOMMODATION&boundary=127.0679338%3B37.2481436%3B127.0823763%3B37.2557626&pageSize=100]
	...
	public void clickOnDataSource(int position){
		...
		switch(position){
			...
			case 4:
				mixContext.toogleDataSource(DataSource.DATASOURCE.BANK);
				break;

			case 5:
				mixContext.toogleDataSource(DataSource.DATASOURCE.HOSPITAL);
				break;

			case 6:
				mixContext.toogleDataSource(DataSource.DATASOURCE.ACCOMMODATION);
				break;
			...
			case 8:
				mixContext.toogleDataSource(DataSource.DATASOURCE.IMAGE);
				break;

			case 9:
				mixContext.toogleDataSource(DataSource.DATASOURCE.VIDEO);
				break;
